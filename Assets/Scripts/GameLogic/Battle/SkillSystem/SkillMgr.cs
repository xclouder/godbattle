...
public class SkillMgr
{
	...
	public void Init()
	{
		...
		var skill1 = new SkillInfo() { Id = 1, Name = "Skill1", CD = 2f};
		var skill2 = new SkillInfo() { Id = 2, Name = "Skill2", CD = 5f};
		var skill3 = new SkillInfo() { Id = 3, Name = "Skill3", CD = 10f};
		var skill4 = new SkillInfo() { Id = 2, Name = "Skill2", CD = 76f};
