...
public class Lua_DG_Tweening_Plugins_UlongPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.UlongPlugin o;
			o=new DG.Tweening.Plugins.UlongPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.UlongPlugin self=(DG.Tweening.Plugins.UlongPlugin)checkSelf(l);
			DG.Tweening.Core.TweenerCore<System.UInt64,System.UInt64,DG.Tweening.Plugins.Options.NoOptions> a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.UInt64> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.UInt64> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.UlongPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.UlongPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.UInt64,System.UInt64,DG.Tweening.Plugins.Options.NoOptions>));
	}
}
