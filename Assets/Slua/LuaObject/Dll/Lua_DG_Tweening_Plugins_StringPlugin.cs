...
public class Lua_DG_Tweening_Plugins_StringPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.StringPlugin o;
			o=new DG.Tweening.Plugins.StringPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int SetFrom(IntPtr l) {
		try {
			DG.Tweening.Plugins.StringPlugin self=(DG.Tweening.Plugins.StringPlugin)checkSelf(l);
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			DG.Tweening.Plugins.StringPlugin self=(DG.Tweening.Plugins.StringPlugin)checkSelf(l);
			DG.Tweening.Plugins.Options.StringOptions a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.String> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.String> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.StringPlugin");
		addMember(l,SetFrom);
		addMember(l,Reset);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.StringPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.String,System.String,DG.Tweening.Plugins.Options.StringOptions>));
	}
}
