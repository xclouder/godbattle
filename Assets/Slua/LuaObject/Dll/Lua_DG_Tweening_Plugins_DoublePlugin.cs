...
public class Lua_DG_Tweening_Plugins_DoublePlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.DoublePlugin o;
			o=new DG.Tweening.Plugins.DoublePlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.DoublePlugin self=(DG.Tweening.Plugins.DoublePlugin)checkSelf(l);
			DG.Tweening.Core.TweenerCore<System.Double,System.Double,DG.Tweening.Plugins.Options.NoOptions> a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.Double> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.Double> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.DoublePlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.DoublePlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.Double,System.Double,DG.Tweening.Plugins.Options.NoOptions>));
	}
}
