...
public class Lua_DG_Tweening_Plugins_Options_VectorOptions : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.Options.VectorOptions o;
			o=new DG.Tweening.Plugins.Options.VectorOptions();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_axisConstraint(IntPtr l) {
		try {
			DG.Tweening.Plugins.Options.VectorOptions self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.Options.VectorOptions");
		addMember(l,"axisConstraint",get_axisConstraint,set_axisConstraint,true);
		addMember(l,"snapping",get_snapping,set_snapping,true);
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.Options.VectorOptions),typeof(System.ValueType));
	}
}
