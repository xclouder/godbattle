...
public class Lua_DG_Tweening_Plugins_Vector3ArrayPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.Vector3ArrayPlugin o;
			o=new DG.Tweening.Plugins.Vector3ArrayPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.Vector3ArrayPlugin self=(DG.Tweening.Plugins.Vector3ArrayPlugin)checkSelf(l);
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			DG.Tweening.Plugins.Vector3ArrayPlugin self=(DG.Tweening.Plugins.Vector3ArrayPlugin)checkSelf(l);
			DG.Tweening.Plugins.Options.Vector3ArrayOptions a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.Vector3ArrayPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.Vector3ArrayPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<UnityEngine.Vector3,UnityEngine.Vector3[],DG.Tweening.Plugins.Options.Vector3ArrayOptions>));
	}
}
