...
public class Lua_DG_Tweening_Plugins_LongPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.LongPlugin o;
			o=new DG.Tweening.Plugins.LongPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.LongPlugin self=(DG.Tweening.Plugins.LongPlugin)checkSelf(l);
			DG.Tweening.Core.TweenerCore<System.Int64,System.Int64,DG.Tweening.Plugins.Options.NoOptions> a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.Int64> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.Int64> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.LongPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.LongPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.Int64,System.Int64,DG.Tweening.Plugins.Options.NoOptions>));
	}
}
