...
public class Lua_DG_Tweening_Plugins_QuaternionPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.QuaternionPlugin o;
			o=new DG.Tweening.Plugins.QuaternionPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.QuaternionPlugin self=(DG.Tweening.Plugins.QuaternionPlugin)checkSelf(l);
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			DG.Tweening.Plugins.QuaternionPlugin self=(DG.Tweening.Plugins.QuaternionPlugin)checkSelf(l);
			DG.Tweening.Plugins.Options.QuaternionOptions a1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.QuaternionPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.QuaternionPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions>));
	}
}
