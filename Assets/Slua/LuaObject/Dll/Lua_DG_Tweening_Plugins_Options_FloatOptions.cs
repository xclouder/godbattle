...
public class Lua_DG_Tweening_Plugins_Options_FloatOptions : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.Options.FloatOptions o;
			o=new DG.Tweening.Plugins.Options.FloatOptions();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_snapping(IntPtr l) {
		try {
			DG.Tweening.Plugins.Options.FloatOptions self;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.Options.FloatOptions),typeof(System.ValueType));
	}
}
