...
public class Lua_DG_Tweening_Plugins_FloatPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.FloatPlugin o;
			o=new DG.Tweening.Plugins.FloatPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.FloatPlugin self=(DG.Tweening.Plugins.FloatPlugin)checkSelf(l);
	...
	static public int GetSpeedBasedDuration(IntPtr l) {
		try {
			DG.Tweening.Plugins.FloatPlugin self=(DG.Tweening.Plugins.FloatPlugin)checkSelf(l);
			DG.Tweening.Plugins.Options.FloatOptions a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.Single> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.Single> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.FloatPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.FloatPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions>));
	}
}
