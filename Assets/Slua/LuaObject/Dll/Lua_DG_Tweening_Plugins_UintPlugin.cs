...
public class Lua_DG_Tweening_Plugins_UintPlugin : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			DG.Tweening.Plugins.UintPlugin o;
			o=new DG.Tweening.Plugins.UintPlugin();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Reset(IntPtr l) {
		try {
			DG.Tweening.Plugins.UintPlugin self=(DG.Tweening.Plugins.UintPlugin)checkSelf(l);
			DG.Tweening.Core.TweenerCore<System.UInt32,System.UInt32,DG.Tweening.Plugins.Options.NoOptions> a1;
	...
	static public int EvaluateAndApply(IntPtr l) {
		try {
			...
			System.Boolean a3;
			checkType(l,4,out a3);
			DG.Tweening.Core.DOGetter<System.UInt32> a4;
			LuaDelegation.checkDelegate(l,5,out a4);
			DG.Tweening.Core.DOSetter<System.UInt32> a5;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DG.Tweening.Plugins.UintPlugin");
		addMember(l,Reset);
		addMember(l,SetFrom);
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.UintPlugin),typeof(DG.Tweening.Plugins.Core.ABSTweenPlugin<System.UInt32,System.UInt32,DG.Tweening.Plugins.Options.NoOptions>));
	}
}
